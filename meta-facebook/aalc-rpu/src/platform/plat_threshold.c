...
bool pump_status_recovery()
{
	...
	uint8_t check_fault[] = {
		...
		SENSOR_NUM_BPB_RPU_COOLANT_OUTLET_TEMP_C, SENSOR_NUM_BPB_RPU_COOLANT_INLET_TEMP_C,
...
sensor_threshold threshold_tbl[] = {
	{ SENSOR_NUM_BPB_RPU_COOLANT_INLET_TEMP_C, THRESHOLD_ENABLE_UCR, 0, 55, abnormal_temp_do, 0 },
	{ SENSOR_NUM_BPB_RPU_COOLANT_OUTLET_TEMP_C, THRESHOLD_ENABLE_UCR, 0, 55, abnormal_temp_do, 0 },
	{ SENSOR_NUM_MB_RPU_AIR_INLET_TEMP_C, THRESHOLD_ENABLE_UCR, 0, 42, abnormal_temp_do, 0 },
